...
#include "../debug/libsoc_debug.h"
#include "../file/libsoc_file.h"

void libsoc_i2c_debug (const char *func, i2c * i2c, char *format, ...)
{
#ifdef DEBUG
...
int libsoc_i2c_ioctl(i2c * i2c, int num_messages)
{
